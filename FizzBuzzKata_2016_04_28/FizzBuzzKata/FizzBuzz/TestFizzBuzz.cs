...
namespace FizzBuzz
{
    ...
    class TestFizzBuzz
    {
        ...
        [TestCase("2")]
        [TestCase("4")]
        public void IsFizzBuzz_GivenNaturalNumbers_ShouldReturnNumber(string input)
        {
            //---------------Set up test pack-------------------
        ...
        [TestCase("30")]
        [TestCase("75")]
        public void IsFizzBuzz_GivenDivisibleByBoth_ShouldReturnFizzBuzz(string input)
        {
            //---------------Set up test pack-------------------
            var fizzBuzz = CreateFizzBuzz();
