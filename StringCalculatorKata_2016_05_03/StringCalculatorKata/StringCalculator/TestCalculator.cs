...
namespace StringCalculator
{
    class TestCalculator
    {
        ...
        [Test]
        public void Add_GivenMultiNumbers_ShouldReturnSum()
        {
            //---------------Set up test pack-------------------
            var calculator = CreateCalculator();
            var numbers = "1,2,3";
        ...
        [Test]
        public void Add_GivenBeginningWithASeparateLineDelimiter_ShouldReturnSum()
        {
            //---------------Set up test pack-------------------
            var calculator = CreateCalculator();
            var numbers = "//;\n1;2";
        ...
        [Test]
        public void Add_GivenGreaterThanAThousand_ShouldReturnIgnore()
        {
            //---------------Set up test pack-------------------
            var calculator = CreateCalculator();
            var numbers = "1001,2";
