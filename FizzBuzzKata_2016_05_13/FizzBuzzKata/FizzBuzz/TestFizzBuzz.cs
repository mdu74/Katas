...
namespace FizzBuzz
{
    ...
    class TestFizzBuzz
    {
        ...
        [Test]
        public void IsFizzBuzz_GivenNotDivisibleByEitherThreeOrFive_ShouldReturnNumber()
        {
            //---------------Set up test pack-------------------
            var fizzBuzz = CreateFizzBuzz();
            var input = "2";
        ...
        [Test]
        public void IsFizzBuzz_GivenDivisibleByBothThreeAndFive_ShouldReturnFizzBuzz()
        {
            //---------------Set up test pack-------------------
            var fizzBuzz = CreateFizzBuzz();
            var input = "15";
